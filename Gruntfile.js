module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        'banner': {
            'full': [
                '/*!',
                ' * crudstorage v<%= pkg.version %>',
                ' *',
                ' * Copyright (c) <%= grunt.template.today("yyyy") %>, @pazguille',
                ' * Released under the MIT license.',
                ' */\n'
            ].join('\n'),
            'min': '/*! crudstorage v<%= pkg.version %> Released under the MIT license. */'
        },
